...
<table>
    ...
    <tr>
        <td>Изменить URL в соответсвии с тестовыми данными</td>
        <td>http://localhost:8000/?balance=<b>50000</b>&reserved=<b>30000</b></td>
        <td>URL заполнен в соответсвии с тестовыми данными</td>
    </tr>
    <tr>
        <td>Нажать "Enter"</td>
        <td></td>
    ...
    <tr>
        <td>Убедиться, что блок "Рубли" отображаются в соответсвии с тестовыми данными</td>
        <td>На счету: 30'000 ₽
            Резерв: 20'000 ₽
        </td>
        <td>Блок "Рубли" отображаются в соответсвии с тестовыми данными</td>
    </tr>
</table>
